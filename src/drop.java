...
public class drop extends JFrame {
    ...
    private void button1MouseClicked(MouseEvent e) {
        ...
        String sql = "DELETE FROM DEVICE WHERE DNO ="+s;
        try {
            //获取数据连接
            ...
            contentPaneLayout.createParallelGroup()
                .addGroup(GroupLayout.Alignment.TRAILING, contentPaneLayout.createSequentialGroup()
                    ...
                    .addGroup(contentPaneLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                        .addComponent(button1, GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE)
                        .addComponent(textField1, GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE))
                    .addGap(143, 143, 143))
        );
